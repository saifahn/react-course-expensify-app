...
const expenseOne = store.dispatch(addExpense({ description: 'Rent', amount: 300, createdAt: -20100 }));
const expenseTwo = store.dispatch(addExpense({ description: 'Coffee', amount: 260, createdAt: -1000 }));
